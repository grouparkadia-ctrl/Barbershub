    ...
    if (window.pageYOffset > 1000 && !isShown) {
        drawNotification({
            ...
            html: `
                    ...
                    <a class="btn theme-element" href="https://www.fresha.com/a/barbers-hub-elizabetes-75-riga-centra-rajons-elizabetes-iela-75-ea5w7da6/all-offer?menu=true&share=true&pId=46463" target="_blank" rel="noopener">Book now</a>
                `,
            customClass: {
                popup: 'promo_popup',
